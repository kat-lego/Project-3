...
class assign_feedback_customfeedback extends assign_feedback_plugin {
    ...
    */
    function get_testcase_filearea($question_number){
    ...
    */
    function get_callback_url($assign_id,$question_number){
        global $CFG;
    ...
    * @return void
    */
    function mform_title(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_type_selection(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_ordering_selection(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_rerun_selection(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_default_score_inputbox(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_unit_inputbox(MoodleQuickForm $mform){
        $default_unit = "units";
        if($this->get_config('scoreunits') !== "units" && $this->get_config('scoreunits')!=0){
            $default_unit = $this->get_config('scoreunits');
        }
        $mform->addElement('text', 'assignfeedback_customfeedback_scoreunits', get_string('scoreunits', 'assignfeedback_customfeedback'), null, null);
    ...
    * @return void
    */
    function mform_language_selection(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_grading_options(MoodleQuickForm $mform){
        ...
        file_prepare_draft_area($draftitemid,40, 'assignfeedeback_customfeedback', 'attachment', null, array('subdirs' => 0, 'maxbytes' => $max_bytes, 'maxfiles' => 1));
    ...
    * @return void
    */
    function mform_rejudge_checkbox(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_judge_nochange(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_num_question_options(MoodleQuickForm $mform){
    ...
    * @return void
    */
    function mform_disable_form(MoodleQuickForm $mform, $dependent,$condition){
